! function(e) {
    ...
    var m, f, g, v = a.MutationObserver || a.WebKitMutationObserver || !1,
        w = Date.now || function() {
        ...
        x = function(e, p) {
            ...
            if (this.scrollrunning = !1, this.scrollmom = !1, this.observer = !1, this.observerremover = !1, this.observerbody = !1, !1 !== g.scrollbarid) this.id = g.scrollbarid;
            else
                do {
                    this.id = "ascrail" + i++
            ...
            if (E.prototype = {
                ...
                T.hastranslate3d && g.enabletranslate3d ? (this.setScrollTop = function(e, o) {
                    ...
                    m.doc.translate.x = e, m.doc.translate.tx = e * M + "px", m.doc.css(T.trstyle, "translate3d(" + m.doc.translate.tx + "," + m.doc.translate.ty + ",0)"), o || m.notifyScrollEvent(m.win[0])
                    ...
                    m.doc.translate.x = e, m.doc.translate.tx = e * M + "px", m.doc.css(T.trstyle, "translate(" + m.doc.translate.tx + "," + m.doc.translate.ty + ")"), o || m.notifyScrollEvent(m.win[0])
                })
            ...
            this.getDocumentScrollOffset = function() {
                ...
                if ((T.isie11 || T.isie10) && (e["-ms-overflow-style"] = "none"), m.ishwscroll && (this.doc.css(T.transitionstyle, T.prefixstyle + "transform 0ms ease-out"), T.transitionend && m.bind(m.doc, T.transitionend, m.onScrollTransitionEnd, !1)), m.zindex = "auto", m.ispage || "auto" != g.zindex ? m.zindex = g.zindex : m.zindex = function() {
                    ...
                    u.attr("id", m.id), u.addClass("nicescroll-rails nicescroll-rails-vr"), g.scrollCLass && u.addClass(g.scrollCLass);
                    var h, p, w = ["left", "right", "top", "bottom"];
                    for (var b in w) p = w[b], (h = g.railpadding[p] || 0) && u.css("padding-" + p, h + "px");
                    ...
                    if (!g.boxzoom || m.ispage || T.isieold || (x = l.createElement("div"), m.bind(x, "click", m.doZoom), m.bind(x, "mouseenter", function() {
                            ...
                            "-moz-border-radius": g.cursorborderradius,
                            "border-radius": g.cursorborderradius
                        }), T.isieold && d.css("overflow", "hidden"), d.addClass("nicescroll-cursors"), m.cursorh = d, (y = n(l.createElement("div"))).attr("id", m.id + "-hr"), y.addClass("nicescroll-rails nicescroll-rails-hr"), g.scrollCLass && y.addClass(g.scrollCLass), y.height = Math.max(parseFloat(g.cursorwidth), d.outerHeight()), y.css({
                            height: y.height + "px",
                            zIndex: m.zindex,
                            background: g.background
                    ...
                    if (!1 === g.autohidemode ? (m.autohidedom = !1, m.rail.css({
                        ...
                        m.ontouchstart = function(e) {
                            ...
                            if (m.hasmoving = !1, m.scrollmom.timer && (m.triggerScrollEnd(), m.scrollmom.stop()), !m.railslocked) {
                                var o = m.getTarget(e);
                                if (o)
                                    if (/INPUT/i.test(o.nodeName) && /range/i.test(o.type)) return m.stopPropagation(e);
                                ...
                                if (m.rail.drag = {
                                        ...
                                        dl: !1,
                                        tg: o
                                    }, m.ispage || !g.directionlockdeadzone) m.rail.drag.dl = "f";
                                else {
                                    var i = {
                                            w: c.width(),
                                            h: c.height()
                        ...
                        m.ontouchmove = function(e, o) {
                            ...
                            if (2 == m.rail.drag.pt) {
                                ...
                                var s = e.clientY + t,
                                    ...
                                    c = a - m.rail.drag.x,
                                    d = m.rail.drag.st - n;
                                if (m.ishwscroll && g.bouncescroll) d < 0 ? d = Math.round(d / 2) : d > m.page.maxh && (d = m.page.maxh + Math.round((d - m.page.maxh) / 2));
                                else if (d < 0 ? (d = 0, s = 0) : d > m.page.maxh && (d = m.page.maxh, s = 0), 0 === s && !m.hasmoving) return m.ispage || (m.rail.drag = !1), !0;
                                ...
                                if (m.railh && m.railh.scrollable && (u = m.isrtlmode ? c - m.rail.drag.sl : m.rail.drag.sl - c, m.ishwscroll && g.bouncescroll ? u < 0 ? u = Math.round(u / 2) : u > m.page.maxw && (u = m.page.maxw + Math.round((u - m.page.maxw) / 2)) : (u < 0 && (u = 0, a = 0), u > m.page.maxw && (u = m.page.maxw, a = 0))), !m.hasmoving) {
                                    ...
                                    if (m.rail.drag.ck ? "v" == m.rail.drag.ck ? p > f && h <= L ? m.rail.drag = !1 : h > f && (m.rail.drag.dl = "v") : "h" == m.rail.drag.ck && (h > f && p <= L ? m.rail.drag = !1 : p > f && (m.rail.drag.dl = "h")) : h > f && p > f ? m.rail.drag.dl = "f" : h > f ? m.rail.drag.dl = p > L ? "f" : "v" : p > f && (m.rail.drag.dl = h > L ? "f" : "h"), !m.rail.drag.dl) return m.cancelEvent(e);
            ...
            this.onscreenresize = function(e) {
                ...
                if ("onwheel" in l.createElement("div")) m._bind(r, "wheel", o, t || !1);
                else {
            ...
            this.delegate = function(e, o, t, r, i) {
                ...
                var s = d[o] || !1;
                if (s && s.l)
                    for (var n = 0, l = s.l.length; n < l; n++) s.a[n] === m.id && (s.a.splice(n), s.l.splice(n), 0 === s.a.length && (m._unbind(e, o, s.l.f), d[o] = null))
                ...
                m.events.push({
                    ...
                    b: r,
                    q: !1
                }), _ && (i || e == window.document || e == window.document.body || e == window) ? e.addEventListener(o, t, {
                    passive: !1,
                    capture: r
                ...
                for (var e in m.stop(), m.cursortimeout && clearTimeout(m.cursortimeout), m.delaylist) m.delaylist[e] && h(m.delaylist[e].h);
